...
export async function main(rc_chain_config?: ChainConfig, ah_chain_config?: ChainConfig) {
    const relayChainConfig: ChainConfig = rc_chain_config ? rc_chain_config :
    {
    ...
    console.log("rc_chain_config",rc_chain_config);
    console.log("ah_chain_config",ah_chain_config);


    const { context, apis } = await setupTestContext(relayChainConfig, assetHubConfig);
...
async function setupTestContext(relayChainConfig: ChainConfig, assetHubConfig: ChainConfig): Promise<{ context: TestContext; apis: ApiPromise[] }> {
